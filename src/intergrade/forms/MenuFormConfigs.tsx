...
export const getMenuFormItemConfigMap = (menu: Menu, pagesProps: PagesProps): MenuFormItemConfigMap => {
  /** roleId */
  menu_roleId.pagesProps = pagesProps;
  const menu_roleIdValue =menu.roleId;
  menu_roleId.config.initialValue = menu_roleIdValue;
  menu_roleId.data = menu_roleIdValue;
  /** checked */
  menu_checked.pagesProps = pagesProps;
  ...
  /** 对应后台系统controlle名称 */
  menu_controllerName.pagesProps = pagesProps;
  ...
  /** 对应后台系统method名称 */
  menu_methodName.pagesProps = pagesProps;
  ...
  /** checkType */
  menu_checkType.pagesProps = pagesProps;
  ...
  /** 创建时间 TIMESTAMP*/
  menu_createTime.pagesProps = pagesProps;
  ...
  /** 更新时间 TIMESTAMP*/
  menu_updateTime.pagesProps = pagesProps;
